            ...
            <div className="flex flex-col items-center justify-center min-h-100 bg-gray-800 rounded-lg p-8">
              {generatedQR ? (
                ...
                <div className="flex flex-col items-center">
                  <div className="w-64 h-64 bg-gray-700 rounded-lg flex items-center justify-center mb-4">
                  ...
                  <p className="text-gray-400 text-center">Fill in the details and click "Generate QR Code"</p>
                </div>
              )}
            </div>
